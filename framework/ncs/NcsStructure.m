classdef NcsStructure < handle
    ...
    methods
      ...
      function createNodes(obj)
            ...
            SensorNode(obj.ncsPlant.stateSize, controllerNodeNr, sensorNodeNr,obj.ncsPlant, obj.simTime) ...
            );

            % Controller Node
            obj.addNode("ControllerNode", ...
            ControllerNode(0, controllerNodeNr, obj.ncsPlant, obj.controlParams.RampC, 'RampC') ...
            );
